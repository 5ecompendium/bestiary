...
* At will: <i>create or destroy water, detect evil and good, detect magic, fog cloud, purify food and drink</i>

* 3/day each: <i>tongues, water breathing, water walk</i>

* 1/day each: <i>conjure elemental </i>(water elemental only)<i>, control water, gaseous form, invisibility, plane shift</i>
